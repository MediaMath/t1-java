...
You can integrate the latest t1-java build easily by just including the following lines in your pom.xml.
 ...
 You can also download the latest jar from Maven Central or from the following source - https://oss.sonatype.org/content/repositories/releases/com/mediamath/t1-java/1.0.0/
