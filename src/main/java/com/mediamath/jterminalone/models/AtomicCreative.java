...
public class AtomicCreative implements T1Entity {
		...
		public enum adFormats {DISPLAY, EXPANDABLE, MOBILE};

		public enum adServers {ATLAS, DART, EYEWONDER, MEDIAMIND,MEDIAPLEX, POINTROLL, YIELD_MANAGER,TERMINALONE, MEDIAFORGE, OTHER};

		public enum expandDir {NONRESTRICTED};
		public enum expandTrig  {AUTOMATIC, MOUSEOVER, CLICK};
		public enum fileTypes  {swf, gif, html5, jpg, jpeg, tif,tiff, png, unknown, vast};
		public enum mediaTypes  {display, video, mobile};
		public enum tagTypes  {SCRIPT, IFRAME, NOSCRIPT};
