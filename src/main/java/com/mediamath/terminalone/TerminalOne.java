...
public class TerminalOne {
     ...
     *
     * @param entity expects ZipCodes entity.
     ...
     *
     * @param entity expects User entity.
     * @return User object.
     * @throws ClientException a client exception is thrown if any error occurs.
     * @throws ParseException  a parse exception is thrown when the response cannot be
     *                         parsed.
     ...
     *
     * @param filePath a valid filePath is required.
     * @param fileName a valid fileName is required.
     * @param name     a valid name is required.
     * @return TPASCreativeUpload object.
     * @throws ClientException a client exception is thrown if any error occurs.
     * @throws IOException     a IOException is thrown when the file cannot be uploaded.
     */
     ...
     * @param filePath   a valid filePath is required.
     * @param fileName   a valid fileName is required.
     * @param creativeId a valid creativeId is required.
     * @return VideoCreativeResponse object.
     * @throws ClientException a client exception is thrown if any error occurs.
     * @throws IOException     IoException is thrown in case if there is an error while
     *                         uploading a file.
     */
     ...
     * @param filePath a valid filePath is required.
     * @param fileName a valid fileName is required.
     * @param key      a valid key is required.
     * @param host     a valid host is required.
     * @return VideoCreativeResponse object.
     * @throws ClientException a client exception is thrown if any error occurs.
     * @throws IOException     IoException is thrown in case if there is an error while
     *                         uploading a file.
     ...
     *
     * @param response      a valid JSON response string is required.
     * @param QueryCriteria a valid query object is required.
     * @return JsonResponse<?       extends       T1Entity> JsonResponse of type T is
     * returned.
     * @throws ClientException a client exception is thrown if any error occurs.
     * @throws ParseException  a parse exception is thrown when the response cannot be
     ...
     *
     * @param Contracts expects a Vendor Contracts entity
