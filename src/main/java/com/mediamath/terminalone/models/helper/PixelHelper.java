...
public class PixelHelper {
  ...
  public static void validateRequiredFields(Pixel entity) throws T1Exception {
    if (entity.getPricing().equals(pricing.CPM) && entity.getCost_cpm() <= 0f
        && entity.getCost_pct_cpm() <= 0f) {
    ...
    if (entity.getPixel_type().equals(pixel_types.event) && entity.getKeywords() != null
