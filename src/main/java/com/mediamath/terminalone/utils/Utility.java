...
public class Utility {
     ...
     *
     * @param bool requires a boolean value.
     ...
     *
     * @param entity     requires a Form object for specific entity
     * @param entityName specify the entity name for fetching read only fields.
     * @return Form object.
     */
     ...
     *
     * @param collection specify the entity name for fetching service paths.
     * @return Form object.
     */
