...
public class Connection {
     ...
     * @param data    requires a Form data object.
     * @param userMap requires a valid user login session.
     * @return Response object.
     * @throws ClientException throws a client exception.
     */
     ...
     * @param data    FormDataMultiPart object.
     * @param userMap requires a valid logged in user session.
     * @return Response object.
     ...
     *
     * @param url     requires api end point url.
     * @param data    Json String to post.
     * @param userMap requires a valid login user information.
     * @return Response object.
     * @throws ClientException exception.
     */
     ...
     *
     * @param url     requires a valid url api endpoint.
     * @param userMap requires a valid user login session.
     * @return Response object.
     */
